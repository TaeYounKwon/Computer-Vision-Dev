...
def run(
        ...
        data=ROOT / 'data/data_birds_x.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / './video/test.mp4', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'data/data_birds_x.yaml', help='(optional) dataset.yaml path')
